...
function load_constants(constants)
  ...
  SHIP_COST, DROPOFF_COST, MAX_HALITE, MAX_TURNS
  EXTRACT_RATIO, MOVE_COST_RATIO
  INSPIRATION_ENABLED, INSPIRATION_RADIUS, INSPIRATION_SHIP_COUNT
  INSPIRED_EXTRACT_RATIO, INSPIRED_BONUS_MULTIPLIER, INSPIRED_MOVE_COST_RATIO
  ...
  -- The maximum number of turns a game can last - smaller maps play fewer turns.
